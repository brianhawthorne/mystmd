...
- 4a745b2: Incorrect error about .\* image extension, but only when image is not found
- 7b844a9: Fix embedding of raw `code` nodes with `remove-input`
- c96b083: Fix indentation of log message
- Updated dependencies [0b28481]
- Updated dependencies [0b28481]
- Updated dependencies [224da08]
